...
import com.badoo.ribs.samples.transitionanimations.rib.child2parent.Child2ParentBuilder
...
internal open class ParentChildBuilders {
    ...
    val child2Builder: Child2ParentBuilder = Child2ParentBuilder(Child2Builder())
